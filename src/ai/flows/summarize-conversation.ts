...
/**
 * @fileOverview A flow to summarize the conversation history.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following conversation history. Be concise and focus on the key points discussed.\n\nConversation History:\n{{{conversationHistory}}}`,
});
